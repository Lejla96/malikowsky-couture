    ...
    <div className="min-h-screen luxury-gradient flex items-center justify-center py-20 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="w-16 h-16 bg-gradient-to-br from-champagne-500 to-champagne-700 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-ivory-50 border border-champagne-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-champagne-300"
